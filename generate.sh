...
GENERATED="$(go env GOPATH)/src/github.com/rarimo/rarime-orgs-svc/resources"
OPENAPI_DIR="$(go env GOPATH)/src/github.com/rarimo/rarime-orgs-svc/docs/web_deploy"
